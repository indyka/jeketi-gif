...
if ( !function_exists( 'wbc_shop_primary_colors' ) ) {
	...
	function wbc_shop_primary_colors( $colors ) {
		...
		$new_css = array(
			...
			'border-color' => '.single-product div.product .woocommerce-product-gallery .woocommerce-product-gallery__trigger:hover,.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button',
